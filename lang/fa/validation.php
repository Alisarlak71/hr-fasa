...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'establishment_date'=>'تاریخ تولد/تاسیس',
        'address'=>'آدرس',
        'national_code'=>'کد ملی',
        'postal_code'=>'کد پستی',
        'phone'=>'شماره تلفن',
        'statute_id'=>'فایل اساس نامه',
        'certificate_changes_id'=>'فایل گواهی تغییرات',
        'official_newspaper_id'=>'فایل روزنامه رسمی',
        'signature_certificate_id'=>'فایل گواهی امضا',
        'official_letter_introduction_id'=>'فایل نامه معرفی رسمی',
        'agent_national_card_id'=>'کارت ملی نماینده',
        'agent_birth_certificate_id'=>'شناسنامه نماینده',
        'ceo_national_card_id'=>'کارت ملی مدیرعامل',
        'added_value_certificate_id'=>'گواهی ارزش افزوده'
    ],
