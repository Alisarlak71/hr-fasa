        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::item-->
                    <!--begin::item-->
                    <li class="breadcrumb-item text-muted"> لیست حاضرین</li>
                    <!--end::item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1"> لیست نفرات حاضر</span>
                            <span class="text-muted mt-1 fw-semibold fs-7"></span>
                        </h3>
                        <a class="btn-primary" href="{{ url('admin/users/foods/export') }}">
                            خروجی اکسل
                        </a>
                    </div>
                    <th class="p-0 min-w-70px">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="pe-2">
                                {{ \Morilog\Jalali\CalendarUtils::strftime('%A d/F/Y',time()) }}
                            </div>
                        </div>
                    </th>
                </div>
                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                            ...
                            @foreach($userActs as $ac)
                                <tr>
                                    ...
                                    <td class="text-table">
                                        {{$ac->getUser->name.' '.$ac->getUser->lname}}
                                    </td>
                                    <td class="text-table">
                                        {{$ac->getUser->code}}
                                    </td>
