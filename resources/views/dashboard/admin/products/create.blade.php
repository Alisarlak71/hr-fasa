                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">افزودن محصول</span>
                                    ...
                                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10 border-dotted border-1 border-gray-400 rounded">
                                        ...
                                        <div class="card card-flush ">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <select class="form-select mb-2" name="product_type"
                                                    ...
                                                    <option></option>
                                                    <option value="1" selected="selected">کالا</option>
                                        ...
                                        <div class="card card-flush ">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <!--end::Tags-->
                                                <!--begin::انتخاب2-->
                                                <select class="form-select mb-2" data-control="select2" autocomplete="off"
                                                        name="category_id"
                                        ...
                                        <div class="card card-flush ">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <select class="form-select mb-2" name="product_status"
                                                        ...
                                                        id="kt_ecommerce_add_product_status_select">
                                                    <option></option>
                                                    <option value="2" selected="selected">منتشر شده</option>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#kt_ecommerce_add_product_submit").on('click', function (e) {
                ...
                if (title !== '' && description !== '' && type !== '' && category_id !== '' && price !== '' && status !== '') {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            setTimeout(() => {
                                window.location='/admin/products/'+response['product']['id']+'/edit';
                            }, 2000)
                        },
                        error: function (xhr) {
                            hideProgressButton(submitElement);
