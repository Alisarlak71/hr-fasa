            ...
            <div class="col-xl-10">
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1"> مدارک کاربران</span>
                ...
                <div class="card-body pt-3">
                    ...
                    <div class="d-flex align-items-center gap-3 flex-wrap mb-2">
                        <form action="/admin/users/documents" method="get">
                            <input name="filter" value="{{$_GET['filter']??''}}" class="form-control"
                                   placeholder="کد پرسنلی">
                        </form>
                        <form action="/admin/users/documents" method="get">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                            ...
                            <thead>
                            <tr class="border-0">
                                <th class="p-0 min-w-70px">کد پرسنلی</th>
                                <th class="p-0 min-w-100px ">نام</th>
                                <th class="p-0 min-w-100px ">مدارک ارسال شده</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-table">
                                        <div style="text-align: right">
                                            @foreach(\App\Enums\docTypes::types as $k=>$t)
                                                <b>{{ $t }}:</b>
                                                @php
                                                    $docs = $ac->getDocs->where('type',$k)
                                                @endphp
                                                @if(sizeof($docs)>0)
                                                    @foreach($docs as $doc)
